...
class AnalizadorLogsRailway:
    ...
    def analizar_creditos(self, logs):
        ...
        if not creditos_mencionados:
            print("ℹ  No se encontró información de créditos en los logs\n")
            return
        ...
        if creditos_remaining:
            ...
            if ultimo['cantidad'] < 1000:
                ...
                print("     ADVERTENCIA: Créditos bajos")
            else:
    ...
    def generar_reporte(self):
        ...
        if total_issues == 0:
            ...
            print(f"  ATENCIÓN REQUERIDA - {len(self.warnings)} warnings detectados")
        else:
        ...
        if 'cuota_excedida' in self.problemas_criticos:
            print("   1.   URGENTE: Recargar créditos de ElevenLabs")

        if 'timeout_audio' in self.problemas_criticos:
            print("   2.   Revisar FIX 203: Reducir tamaño de mensajes")
