    ...
    try:
        ...
        if hasattr(subscription, 'character_count'):
            ...
            if caracteres_restantes < 10000:  # Menos de 10k caracteres = ~30 llamadas
                ...
                print("     Créditos MUY BAJOS")
                print("     Recargar INMEDIATAMENTE")
                print(f"     Solo quedan ~{llamadas_restantes} llamadas")
                status = "CRITICO"
            ...
            print("  No se pudo obtener información de caracteres")
